 ...
 */
final class Version20220928172403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, type ENUM(\'Végétarien\', \'Viande\') NOT NULL COMMENT \'Viande(DC2Type:EnumCategory)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
